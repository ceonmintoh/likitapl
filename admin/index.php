            ...
            <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;" >
                        ...
                        <tr >
                            ...
                            <td colspan="2" class="nav-bar" >
                                ...
                                <form action="hospital.php" method="post" class="header-search">
        
                                    <input type="search" name="search" class="input-text header-searchbar" placeholder="Search Doctor name or Email" list="doctors">&nbsp;&nbsp;
                                    
                                    <?php
// Fetch hospital names and emails from the hospital table
$listHospitals = $database->query("SELECT name, email FROM hospital;");

// Output the datalist for hospitals
echo '<datalist id="hospitals">';
while ($hospital = $listHospitals->fetch_assoc()) {
    $hospitalName = $hospital["name"];
    $hospitalEmail = $hospital["email"];
    echo "<option value='$hospitalName'><br/>";
    echo "<option value='$hospitalEmail'><br/>";
}
echo '</datalist>';
?>
                            ...
                            <td width="15%">
                                ...
                                $doctorrow = $database->query("select  * from  hospital;");
